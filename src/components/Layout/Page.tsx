...
export const PageMeta: React.FC<React.PropsWithChildren<{ symbol?: string }>> = ({ symbol }) => {
  ...
  return (
    <Head>
      ...
      <meta property="og:title" content="DUBYDEX" />
      <meta property="og:description" content="DUBY is Integrated & Powered By Uniswap" />
      <meta property="og:image" content="https://www.dubydex.finanace/dubydex.png" />
